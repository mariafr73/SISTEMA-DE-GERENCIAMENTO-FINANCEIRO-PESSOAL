...
import src.controller.CategoriaController;
...
public class TelaCategoria {
    ...
    private void visualizarCategoria() {
        ...
        for (int i = 0; i < categorias.size(); i++) {
            ...
            String status = categoria.getStatus() ? "Ativa" : "Inativa";

            System.out.println("[" + i + "] " + categoria.getNomeCategoria() + " (" + status + ")");
        }
        ...
        try {
            ...
            Categoria categoriaSelecionada = categorias.get(indice);
    ...
    private void editar() {
        ...
        Categoria categoria = controller.buscar(nomeAtual);
        ...
        boolean sucesso = controller.editar(categoria, novoNome);
    ...
    private void desativar() {
        ...
        boolean sucesso = controller.desativar(categoria);

        if (sucesso) {
            System.out.println("Categoria desativada com sucesso!");
        } else {
            System.out.println("Não foi possível desativar a categoria.");
        }
    }
}