...
import scr.controller.DespesaController;
...
public class TelaDespesa {
    ...
    private void cadastrarDespesa() {
        ...
        try {
            ...
            boolean sucesso =
                    controller.cadastrarDespesa(nome, valor, data, categoria);
    ...
    private void buscarDespesa() {
        ...
        Despesa despesa =
                controller.buscarDespesa(termo);
    ...
    private void editarDespesa() {
        ...
        try {
            ...
            double valor =
                    Double.parseDouble(leitor.nextLine());

            System.out.print("Nova data (dd/MM/yyyy): ");

            Date data =
                    UtilData.parseDataUsuario(leitor.nextLine());
    ...
    private void excluirDespesa() {
        ...
        for (int i = 0; i < despesas.size(); i++) {
            System.out.println(
                    "[" + i + "] " + despesas.get(i).getNomeDespesa());
        }
        ...
        try {
            ...
            boolean sucesso =
                    controller.excluirDespesa(despesas.get(pos).getIdDespesa());
    ...
    private void listarPorCategoria() {
        ...
        try {
            ...
            List<Despesa> despesas =
                    controller.listarPorCategoria(categorias.get(pos).getIdCategoria());
    ...
    private void calcularTotalMensal() {
        ...
        try {
            ...
            double total =
                    controller
                            .calcularDespesaTotalMensal(mes, ano);
